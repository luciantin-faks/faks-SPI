...
CREATE TABLE Dim_Location (
    ...
    order_city VARCHAR(45) NOT NULL , -- city orders_geo
    order_region VARCHAR(45) NOT NULL , -- region orders_geo
    order_state VARCHAR(45) NOT NULL ,  -- state orders_geo
    customer_country VARCHAR(45) NOT NULL , -- customer_geo
    customer_city VARCHAR(45) NOT NULL ,  -- customer_geo
    customer_segment VARCHAR(45) NOT NULL ,  -- customer
    UNIQUE INDEX location_tk_UNIQUE (location_tk ASC)
);

CREATE TABLE Dim_Shipping (
    shipping_tk BIGINT UNSIGNED NOT NULL,
    shipping_mode VARCHAR(45) NOT NULL ,  -- shipping
    days_for_shipping_real INT NOT NULL ,  -- shipping
    days_for_shipping_scheduled INT NOT NULL ,  -- shipping
    late_delivery_risk INT NOT NULL ,  -- orders
...
CREATE TABLE Fact_Item (
    ...
    time_tk BIGINT UNSIGNED NOT NULL,
    product_category_tk BIGINT UNSIGNED NOT NULL,
    discount REAL NOT NULL , -- order item
    profit_ratio REAL NOT NULL , -- order item
    quantity REAL NOT NULL ,  -- order item
